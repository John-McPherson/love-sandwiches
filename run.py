...
def get_sales_data():
    ...
    via the terminal, which must be a string of 6 numbers sperataed 
    by commas. The loop will repeatdly request data, until it is valid. 
    """
    while True:
        print("Please enter sales data grom the last market.")
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined by the sales figure subtracted from the stock:
